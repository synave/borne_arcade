...
public class Serpent {
    ...
    public Serpent ( Fenetre f, Carre c ) {
			...
			serpent.add ( c );
			tete = c;
			Carre corps_1 = new Carre ( Couleur.BLANC, new Point ( tete.getA().getX() - 100, tete.getA().getY() ), 10, true );
			serpent.add ( corps_1 );
			Carre corps_2 = new Carre ( Couleur.BLANC, new Point ( tete.getA().getX() - 200, tete.getA().getY() ), 10, true );
			serpent.add ( corps_2 );
